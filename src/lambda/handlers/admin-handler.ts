/**
 * Lambda handler entry point for admin
 */

import { APIGatewayProxyEvent, APIGatewayProxyResult } from 'aws-lambda';
import { createTenant, createAdmin, listAllTenants, updateTenant } from './admin';
